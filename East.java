...
class East extends JPanel implements ActionListener{

	JLabel nLabel = new JLabel("EAST INDIA");
	JLabel pLabel = new JLabel("Packages of East India");
	...
	ImageIcon icon = new ImageIcon("East1.png");
	...
	public void actionPerformed(ActionEvent fd){
		...
		try{
			...
			PreparedStatement ps = con.prepareStatement("select stay,places from east where name=?");
			ps.setString(1,s);
			ResultSet rs = ps.executeQuery();
			if(rs.next())
			{
