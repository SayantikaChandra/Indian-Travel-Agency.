...
class North extends JPanel implements ActionListener{

	JLabel nLabel = new JLabel("NORTH INDIA");
	JLabel pLabel = new JLabel("Packages of North India");
	...
	ImageIcon icon = new ImageIcon("north1.png");
	...
	public void actionPerformed(ActionEvent fd){
		...
		try{
			...
			PreparedStatement ps = con.prepareStatement("select stay,places from north where name=?");
			ps.setString(1,s);
			ResultSet rs = ps.executeQuery();
			if(rs.next())
			{
